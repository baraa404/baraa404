...
I'm **Baraa Mabrok** — a Flutter developer and UI/UX designer who takes products from Figma to a release people can actually use.

I ship production apps (offline-first commerce, community campaigns, nutrition scanning, media CDNs), lead the **IEEE Computer Science Flutter track** for 30+ students, and treat jank as a bug. Arabic + English.
...
**Instructor & Head of Flutter Track** — IEEE Computer Science Chapter · *2025 – Present*  
Curriculum, weekly workshops (Dart, state management, Firebase), mentoring 30+ students from concept to deploy.

**Flutter Development Trainee** — Digital Egypt Pioneers Initiative (DEPI) · *Jun 2025 – Dec 2025*  
Cross-platform apps with clean architecture, Firebase, BLoC/Provider, REST APIs, production UI.

**Freelance Flutter Developer** — Independent · *Present*  
Client and personal products: architecture, UI/UX, APIs, cloud, and store release.
...
<div align="center">
  ...
  <img src="https://streak-stats.demolab.com?user=baraa404&theme=radical&hide_border=true" height="165" alt="streak" />
</div>
